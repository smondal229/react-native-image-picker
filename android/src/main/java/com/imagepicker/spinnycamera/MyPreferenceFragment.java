...
public class MyPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.spinny_camera_preferences);
...

        {
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    ...
                    BaseSpinnyCameraModuleActivity main_activity = (BaseSpinnyCameraModuleActivity) MyPreferenceFragment.this
                            .getActivity();
        ...
        // AlertDialog.Builder(MyPreferenceFragment.this.getActivity());
        ...
        // try {
        // PackageInfo pInfo =
        // MyPreferenceFragment.this.getActivity().getPackageManager().getPackageInfo(MyPreferenceFragment.this.getActivity().getPackageName(),
        // 0);
        ...
        // }
        // }
        // about_string.append("\nPreview resolution: " + preview_width + "x" +
        // preview_height);
        // if (widths != null && heights != null) {
        // about_string.append("\nPhoto resolutions: ");
        // for (int i = 0; i < widths.length; i++) {
        ...
        // }
        // }
        // about_string.append("\nPhoto resolution: " + resolution_width + "x" +
        // resolution_height);
        ...
        // about_string.append("\nAuto-stabilise?: ");
        // about_string.append(getString(supports_auto_stabilise ?
        // R.string.about_available : R.string.about_not_available));
        // about_string.append("\nAuto-stabilise enabled?: " +
        // sharedPreferences.getBoolean(PreferenceKeys.getAutoStabilisePreferenceKey(),
        // false));
        // about_string.append("\nVideo stabilization?: ");
        // about_string.append(getString(supports_video_stabilization ?
        // R.string.about_available : R.string.about_not_available));
        // about_string.append("\nFlash modes: ");
        ...
        //
        // about_string.append("\nUsing SAF?: " +
        // sharedPreferences.getBoolean(PreferenceKeys.getUsingSAFPreferenceKey(),
        // false));
        ...
        // alertDialog.setNegativeButton(R.string.about_copy_to_clipboard, new
                ...
                public boolean onPreferenceClick(Preference arg0) {
                    if (pref.getKey().equals("preference_reset")) {
                        ...
                        new AlertDialog.Builder(MyPreferenceFragment.this.getActivity())
                                .setIcon(android.R.drawable.ic_dialog_alert).setTitle(R.string.preference_reset)
    ...
    // getActivity().findViewById(R.id.btn_template_list_toggle);
    ...
    public void onResume() {
        ...
        /*
         * if( MyDebug.LOG ) { int r = (backgroundColor >> 16) & 0xFF; int g =
         * (backgroundColor >> 8) & 0xFF; int b = (backgroundColor >> 0) & 0xFF;
    ...
    /*
     * So that manual changes to the checkbox preferences, while the preferences are
     * showing, show up; in particular, needed for preference_using_saf, when the
     * user cancels the SAF dialog (see SpinnnyCameraActivity.onActivityResult).
     */
